...
def tifo_create(request, group_id):
    ...
    return render(request, 'groups/tifo_form.html', {'form': form, 'group': group})
...
def tifo_edit(request, tifo_id):
    ...
    return render(request, 'groups/tifo_form.html', {
        'form': form,
        'group': tifo.group,
        'edit': True 
    })
...
class GroupCreate(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        if country_id:
            form.instance.country = get_object_or_404(Country, id=country_id)
